...
namespace EcommerceBlazor.Server.Migrations
{
    ...
    [Migration("20231021162832_Imagens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommerceBlazor.Shared.Endereco", b =>
                {
            ...
            modelBuilder.Entity("EcommerceBlazor.Shared.Imagem", b =>
                {
                    b.Property<int>("Imagem_ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Imagem_ID"));
            ...
            modelBuilder.Entity("EcommerceBlazor.Shared.ItemCarrinho", b =>
                {
                    b.Property<int>("UsuarioId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("UsuarioId", "ProdutoId", "TipoProdutoId");

                    b.ToTable("ItemCarrinho");
                });

            modelBuilder.Entity("EcommerceBlazor.Shared.ItemPedido", b =>
                {
                    ...
                    b.HasKey("PedidoId", "ProdutoId", "TipoProdutoId");
            ...
            modelBuilder.Entity("EcommerceBlazor.Shared.Pedido", b =>
                {
            ...
            modelBuilder.Entity("EcommerceBlazor.Shared.Endereco", b =>
                {
                    b.HasOne("EcommerceBlazor.Shared.Usuario", null)
                        .WithOne("Endereco")
                        .HasForeignKey("EcommerceBlazor.Shared.Endereco", "UsuarioId")
            ...
            modelBuilder.Entity("EcommerceBlazor.Shared.Imagem", b =>
                {
                    b.HasOne("EcommerceBlazor.Shared.Produto", null)
                        .WithMany("Imagens")
            ...
            modelBuilder.Entity("EcommerceBlazor.Shared.ItemPedido", b =>
                {
                    b.HasOne("EcommerceBlazor.Shared.Pedido", "Pedido")
                        .WithMany("Itens")
